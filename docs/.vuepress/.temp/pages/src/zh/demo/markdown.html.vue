...
<p>一个拥有 ID 的 <strong>单次</strong>{#word}。</p>
<ul>
...
<div class="language-flow ext-flow line-numbers-mode"><pre v-pre class="language-flow"><code>cond<span class="token operator">=></span>condition<span class="token operator">:</span> 是否执行操作<span class="token operator">?</span>
...
<p>向 Mr.Hope 捐赠一杯咖啡。 <em>Recommanded</em></p>
<ul>
...
<p>@file index.ts</p>
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code><span class="token keyword">const</span> msg <span class="token operator">=</span> <span class="token string">"hello world"</span><span class="token punctuation">;</span>
...
<p>一个有文字和 <a href="https://mrhope.site" target="_blank" rel="noopener noreferrer">链接<ExternalLinkIcon/></a> 的段落</p>
<hr>
